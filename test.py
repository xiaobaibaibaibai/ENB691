...
python_time.append(pythonEndTime-pythonStartTime)
numpy_time.append(numPyEndTime-numPyStartTime)
#################################################
...
# data to plot
n_groups = 1
# python_time = [90, 55, 40, 65]
# numpy_time = [85, 62, 54, 20]
...
rects1 = plt.bar(index, python_time[14:15], bar_width,
alpha=opacity,
color='b',
label='Python')
 
rects2 = plt.bar(index + bar_width, numpy_time[14:15], bar_width,
alpha=opacity,
color='g',
label='Numpy')
